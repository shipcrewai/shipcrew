# Agent Instructions for shipply-scout

This file guides AI assistants working on the `shipply-scout` bot handler.

## Bot overview

`bots/shipply-scout/src/shipply_scout/shipply_scout.py` is a Pacto bot handler built on the
...
2. Open `bots/shipply-scout/src/shipply_scout/shipply_scout.py`.
...
Tests import the public API via `from shipply_scout import bot`.
...
After adding commands, update the tests in `bots/shipply-scout/tests/test_bot.py`
if necessary.
